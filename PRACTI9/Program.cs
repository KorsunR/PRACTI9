...
namespace Snake
{
    ...
    internal class Program
    {
        ...
        private static void Draw()
        {
            ...
            $"ШИШКИ: {_tail.Count()}".Write(_size.Width + 3, 5);
        }
        ...
        {
            $"ТЫ ПРОИГРАЛ, ПОПРОБУЙ ЕЩЕ РАЗ ~(>_<~)".Write(_size.Width + 3, 3, ConsoleColor.Red, ConsoleColor.White);
            $"НАЖМИ SPACE ЧТОБ ПРОДОЛЖИТЬ, В ЭТОТ РАЗ ВСЕ ПОЛУЧИТЬСЯ (^_~) ".Write(_size.Width + 3, 4, ConsoleColor.Black, ConsoleColor.Gray);
